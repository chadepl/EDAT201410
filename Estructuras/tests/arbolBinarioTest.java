...
public class arbolBinarioTest extends TestCase{
	 ...
	 */
	private ArbolBinario<String> arbolStrings;

	/**
	 * Arbol de Strings para pruebas de iteradores.
	 */
	private ArbolBinario<String> arbolIterator;
	...
	public void setupEscenario1(){
		...
		arbolStrings=new ArbolBinario<String>();
	...
	public void setupEscenario4(){
		arbolIterator=new ArbolBinario<String>();
