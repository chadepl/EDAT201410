...
import arbolBinOrdenado.IArbolOrdenado;
...
public class arbolBinarioOrdenadoTest extends TestCase{
	 ...
	 */
	private IArbolOrdenado<String> arbolStrings;

	/**
	 * Arbol de Strings para pruebas de iteradores.
	 */
	private ArbolOrdenado<String> arbolIterator;
	...
	public void setupEscenario1(){
		...
		arbolStrings=new ArbolOrdenado<String>();
	...
	public void setupEscenario4(){
		arbolIterator=new ArbolOrdenado<String>();
	...
	/**
	 * Test para probar tanto el metodo agregar como el buscar caso 1.
	 */
	public void testAgregarYBuscar1(){
		...
		assertNull("No se encuentra",arbolStrings.buscar("a"));
	}
	...
	public void testAgregarYEliminar1(){
		...
		for(int i=0;i<25;i++){
			int a = 65+i;
			String ascii=Character.toString((char)a);
			String eliminado=arbolStrings.eliminar(ascii);
			assertEquals("No esta eliminando y/o agregando apropiadamnete", ascii, eliminado);
